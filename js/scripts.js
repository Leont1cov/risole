...
$(function(){
        var hPanelHide = 85; // В каком положении полосы прокрутки прятать верхнюю панель
...
// Animation        
        ...
        if ( !$("html").hasClass("touch") ){
            ...
            if ( !$("body").hasClass("no-animate") ){
                ...
                $('.action-section .row > div, .percent-icon').addClass("hidden");
...
// special-offers begin
        ...
        function specialOffers(){
            $('.special-offers .item .element-content, .special-offers .item .img-wrapper').css({'height':'auto'});
            $('.special-offers .item .element-content').each(function(){
                maxh = Math.max(maxh, parseInt($(this).height()));
            });   
            $('.special-offers .item .element-content, .special-offers .item .img-wrapper').height(maxh);
        }
...
jQuery(window).load(function () {
        ...
        $('.action-section').parallax("50%", 0.4);
        $('.super-offer-section-bottom').parallax("50%", 0.4);
        $('#parallax1').parallax("50%", 0.2);
        $('#parallax2').parallax("50%", 0.4);
        $('#parallax3').parallax("50%", 0.15);
        $('#parallax4').parallax("50%", 0.15);
        $('#parallax5').parallax("50%", 0.1);
        $('#parallax6').parallax("50%", 0.2);
